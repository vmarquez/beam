...
public class RedisStreamIO {
  ...
  public abstract static class ReadStream extends PTransform<PBegin, PCollection<StreamEntry>> {
    ...
    abstract static class Builder {
      ...
      abstract Builder setConsumerPrefix(String consumerPrefix);
    ...
    public ReadStream withConsumerPrefix(String consumerPrefix) {
      return toBuilder().setConsumerPrefix(consumerPrefix).build();
    }
    ...
    public PCollection<StreamEntry> expand(PBegin input) {
      ...
      Stream<StreamDescriptor> streamDescriptors = IntStream.of(this.consumerCount()).mapToObj(i -> new StreamDescriptor(this.keyPattern(), new StreamConsumer(this.consumerPrefix(), i), this.groupId(), batchSize()));
  ...
  public static ReadStream read() {
    return new AutoValue_RedisStreamIO_ReadStream.Builder()
        ...
        .setTimeout(1000)
        .setConsumerCount(1)
        .setConsumerPrefix("beamconsumer")
        .setBatchSize(1)
